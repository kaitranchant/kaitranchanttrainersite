...
export function PhoneMockups() {
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-1/2 h-[75%] w-[85%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(125,150,166,0.28)_0%,rgba(125,150,166,0.1)_42%,transparent_70%)]"
      />
